...
namespace DataWriteAPI.Controllers
{
    ...
    {
        WriteDbContext db;
        public RegisterController(WriteDbContext _db)
        {
            this.db = _db;
        }
        ...
        public void updateRegisters(List<Register> registers)
        {
            foreach (Register register in registers)
            {
                var device = db.BaseDevice.Find(register.baseDeviceId);
                device.WriteRegister(register.address, register.Value);
            }
        }
